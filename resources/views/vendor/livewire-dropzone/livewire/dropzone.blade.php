<div x-cloak x-data="dropzone({
    ...
    <div
        class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-max-w-2xl dz-justify-center bg-transparent dz-p-10">
        @if (!is_null($error))
        ...
        <div class="dz-flex dz-justify-between dz-w-full">
            <label for="upload"
                class="dz-font-medium dz-text-lg dz-mb-2 text-[#000] dark:text-white">{{ __('Upload profile picture') }}
                ...
                <div @click="$refs.input.click()"
                    ...
                    <div>
                        <div x-show="!isDragging"
                            class="dz-flex dz-items-center bg-gray-50 dz-justify-center dz-gap-2 dz-py-8 dz-h-full dark:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            ...
                            <p class="dz-text-md text-gray dark:text-gray-400">Drop here or <span
                                    class="dz-font-semibold text-black dark:text-white">Browse files</span></p>
                        </div>
                        <div x-show="isDragging"
                        ...
                        <div
                            ...
                            <div class="dz-flex dz-items-center dz-gap-3">
                                ...
                                <div class="dz-flex dz-flex-col dz-items-start dz-gap-1">
                                    <div class="dz-text-center text-slate-900 dz-text-sm dz-font-medium dark:text-white">
                                        {{ $file['name'] }}</div>
                            ...
                            <div class="dz-flex dz-items-center dz-mr-3">
                                <button type="button" @click="removeUpload('{{ $file['tmpFilename'] }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="dz-w-6 dz-h-6 text-black dark:text-white">
                                        <path fill-rule="evenodd"

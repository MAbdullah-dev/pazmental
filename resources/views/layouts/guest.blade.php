...
<link rel="manifest" href="{{ asset('assets/images/site.webmanifest') }}" />
    ...
    <body class="font-sans text-gray-900 antialiased">
        <x-mary-toast />
        <div class="min-h-screen flex flex-col mx-2 justify-center items-center pt-6 sm:pt-0  dark:bg-gray-900">
            <div class="flex flex-col items-center gap-4">
                <x-mary-theme-toggle class="ml-[10px] btn btn-circle btn-ghost border border-gray-300 dark:bg-white" />

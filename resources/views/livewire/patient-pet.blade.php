<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-12 text-center">
        ...
        <h2
            class="dark:text-white py-2 text-2xl md:text-3xl xl:text-4xl leading-[1.2] text-black font-semibold text-center dark:text-white">
        ...
        <div class="mt-20 step-form">
            <div
                ...
                <h2
                    class="text-white text-[18px] md:text-[22px] dark:text-white text-[#000] font-semibold uppercase text-left">
